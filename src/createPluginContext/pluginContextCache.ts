...
const pluginContextCache = new WeakMap<SharedPluginContext, PluginContextCache>();

export function getPluginContextCache(pluginName: string, sharedContext: SharedPluginContext) {
